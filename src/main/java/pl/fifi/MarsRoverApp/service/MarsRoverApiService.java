...
import pl.fifi.MarsRoverApp.response.Rover;
...
@Service
public class MarsRoverApiService implements Container{
    private static final String API_KEY = "etRNWeDX6bxjU6CIr5BBKhBNy9XCBgfx9GYYjQ5T";

    private Map<String, List<String>> validCameras = new HashMap<>();

    private ArrayList<String>roverNames = new ArrayList<>();
    ...
    public MarsRoverApiService () {
        roverNames.add("Opportunity");
        roverNames.add("Curiosity");
        roverNames.add("Spirit");
    ...
    public Iterator getIterator() {
        return new RoverNamesIterator();
    }

    private class RoverNamesIterator implements Iterator {
